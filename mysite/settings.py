...
INSTALLED_APPS = [
    ...
    'shop', #app per gestione  prodotti
    'cart', #gestione del carrello
    'imagekit', #gestione delle immagini
    'ckeditor', #editor di testo
    'coupons', #gestione coupon dello shop
    'ckeditor_uploader',
    ...
    'django_cleanup.apps.CleanupSelectedConfig', #cancello i file multimediali relativi ad un model
]
...
#config ckeditor /static/ckeditor
CKEDITOR_BASEPATH = "/static/ckeditor/ckeditor/"
CKEDITOR_UPLOAD_PATH = 'ckEditor/'
CKEDITOR_CONFIGS = {
    'default': {
        'toolbar': 'Classic', #basic per editor di base
    },
}
